        ...
        <div class="adm-card">
            ...
            <div class="adm-card-body">
                <table class="adm-table">
                    <thead><tr>
                        <th>Image</th><th>Name</th><th>Category</th><th>Price</th><th>Stock</th><th style="text-align:center;">Actions</th>
                    </tr></thead>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a href="?delete=<?php echo $p['id']; ?>" class="adm-btn adm-btn-danger" style="font-size:0.75rem;padding:0.5rem 1rem;" onclick="return confirm('Delete this product permanently?')">
